// =========================================================
// IQ TRIVIA RO · Auth Script v2 (Patched)
// P3: import singleton din supabase-client.js (no duplicate createClient)
// =========================================================

import { supabase } from ‘./supabase-client.js’;

// Expune pentru debugging din DevTools (opțional)
window.sb = supabase;
...
// — CITEȘTE ?mode= DIN URL —
const urlMode = new URLSearchParams(window.location.search).get(‘mode’);
if (urlMode === ‘register’ || urlMode === ‘login’) {
setMode(urlMode);
}

console.log(’%c[Auth] Ready v2 (singleton)’, ‘color:#D4AF37;font-weight:bold’);
