// =====================================================
// IQ-TRIVIA-RO / FAZA 3A / MODUL 9B-3: Game Logic v3
// + Insule atacabile direct + Triumph 45/45 strict
// =====================================================
...
function renderIslands() {
  ...
  isolated.forEach(code => {
    ...
    chip.innerHTML = `
      <span class="island-chip-flag">${codeToFlag(code)}</span>
      <span class="island-chip-name">${getCountryName(code)}</span>
    `;
...
async function onConquer() {
  ...
  // *** NOU 9B-3: actualizez chip insulă dacă e cazul ***
  ...
  // Triumph 45/45 strict: 44 cucerite + bază = toate 45 sub control
