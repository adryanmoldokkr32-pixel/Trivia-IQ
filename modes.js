// ====================================================
// IQ TRIVIA RO - Modes Page v3 (ASCII clean)
// P3: import singleton din supabase-client.js
// ====================================================
...
showToastModes(
  mode === 'iq' ? 'Testul IQ vine la Faza 3B' :
...
console.log(’%c[Modes] Ready v3 (singleton)’, ‘color:#D4AF37;font-weight:bold’);
